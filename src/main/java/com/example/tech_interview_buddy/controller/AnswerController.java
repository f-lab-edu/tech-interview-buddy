...
public class AnswerController {
    ...
    public AnswerResponse updateAnswer(@PathVariable Long questionId, @PathVariable Long answerId,
        @RequestBody UpdateAnswerRequest request) {
        return answerService.updateAnswer(questionId, answerId, request);
    }
} 